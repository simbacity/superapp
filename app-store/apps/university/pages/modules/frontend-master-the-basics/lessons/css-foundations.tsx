...
By the end of this lesson, you'll be well on your way to becoming a CSS master! You should have the knowledge and skills you need to tackle any CSS task with confidence and avoid introducing tech debt when writing CSS for frontend components.
    ...
    <Shell>
      ...
      <div className="text-white pt-12 pb-12">
        <div className="mx-auto max-w-3xl px-3 md:px-0 pt-4">
          <h2 className="text-2xl font-bold pb-4 pt-8">CSS foundations</h2>
          <div
