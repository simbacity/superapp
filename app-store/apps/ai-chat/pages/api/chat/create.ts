import { aiChatRequestSchema, AIChatResponse } from "@app-store/apps/ai-chat/api-contracts/ai-chat.schema";
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    const requestBody = aiChatRequestSchema.parse(req.body);
    const response: AIChatResponse = await entity.create(requestBody);
