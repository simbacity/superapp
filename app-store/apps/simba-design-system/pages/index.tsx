      ...
      <div className="layout py-20">
        ...
        <section className="my-20">
          ...
          <p className="lead-paragraph">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec porta arcu a magna scelerisque
            euismod. Morbi in iaculis lectus, nec lacinia lacus. Aenean dignissim vehicula dui. Duis accumsan
            suscipit cursus.
          </p>
        </section>
        <section className="my-20">
          ...
          <p className="paragraph">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec porta arcu a magna scelerisque
            euismod. Morbi in iaculis lectus, nec lacinia lacus. Aenean dignissim vehicula dui. Duis accumsan
            suscipit cursus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec porta arcu a magna
            scelerisque euismod. Morbi in iaculis lectus, nec lacinia lacus. Aenean dignissim vehicula dui.
            Duis accumsan suscipit cursus.
          </p>
        </section>
        <section className="my-20">
        ...
        <section className="my-20">
          ...
          <button className="default-button--small--disabled">Default Button</button>
          <h2 className="h2">.default-button--medium--disabled</h2>
          <button className="default-button--medium--disabled">Default Button</button>
          <h2 className="h2">.default-button--large--disabled</h2>
          <button className="default-button--large--disabled">Default Button</button>
        </section>
        <section className="my-20">
        ...
        <section className="my-20">
          ...
          <button className="primary-button--small--disabled">Primary Button</button>
          <h2 className="h2">.primary-button--medium--disabled</h2>
          <button className="primary-button--medium--disabled">Primary Button</button>
          <h2 className="h2">.primary-button--large--disabled</h2>
          <button className="primary-button--large--disabled">Primary Button</button>
        </section>
        <section className="my-20">
        ...
        <section className="my-20">
          ...
          <button className="danger-button--small--disabled">Danger Button</button>
          <h2 className="h2">.danger-button--medium--disabled</h2>
          <button className="danger-button--medium--disabled">Danger Button</button>
          <h2 className="h2">.danger-button--large--disabled</h2>
          <button className="danger-button--large--disabled">Danger Button</button>
        </section>
        <section className="my-20">
        ...
        <section className="my-20">
          ...
          <button className="invisible-button--small--disabled">Invisible Button</button>
          <h2 className="h2">.invisible-button--medium--disabled</h2>
          <button className="invisible-button--medium--disabled">Invisible Button</button>
          <h2 className="h2">.invisible-button--large--disabled</h2>
          <button className="invisible-button--large--disabled">Invisible Button</button>
        </section>
        <section className="my-20">
          <h2 className="h2">.input</h2>
          <input id="first_input" name="first_input" type="email" className="input" />
        </section>
        <section className="my-20">
          <h2 className="h2">disabled .input</h2>
          <input id="second_input" name="second_input" type="email" disabled className="input" />
        </section>
        <section className="my-20">
          ...
          <input id="label_input" name="label_input" type="email" className="input" />
        </section>
        <section className="my-20">
        ...
        <section className="my-20">
          ...
          <p className="paragraph">
            We are using{" "}
            <a href="https://react-select.com/" target="_blank" rel="noreferrer" className="link">
              React Select
            </a>{" "}
        ...
        <section className="my-20">
          ...
          <textarea rows={4} className="textarea" placeholder="What's on your mind..."></textarea>
        </section>
      </div>
    </Shell>
  );
