import { MessageDefaultResponse } from "@app-store/apps/town-square/api-contracts/message.schema";
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const response: MessageDefaultResponse = await entity.delete(id, session.user.id);
