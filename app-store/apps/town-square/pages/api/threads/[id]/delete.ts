import { ThreadDefaultResponse } from "@app-store/apps/town-square/api-contracts/thread.schema";
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const response: ThreadDefaultResponse = await entity.delete(id, session.user.id);
