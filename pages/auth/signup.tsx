            ...
            <div>
              ...
              <div className="py-2">
                ...
                <input
                  ...
                  className="input"
                />
                {errorMessage && <div className="mt-2 font-mono text-red-700">{errorMessage}</div>}
              </div>
              <button type="submit" className="primary-button--medium w-full mt-2">
                Sign up with Google
              </button>
            </div>
          </form>
        ...
        {Object.values(providers).map((provider) => {
          return (
            <div key={provider.name}>
              <SignInWithGoogleButton text="Sign up with Google" onClick={() => signIn(provider.id)} />
            </div>
          );
        })}
      </div>
