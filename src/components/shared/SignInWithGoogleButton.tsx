...
export default function SignInWithGoogleButton({
  ...
  return (
    <button
      onClick={onClick}
      className="m-auto flex items-center space-x-3 rounded bg-white py-1 pl-1 pr-3 text-gray-600 shadow-md hover:opacity-90"
    >
      <div className="rounded bg-white py-2 pl-2 pr-1">
        <GoogleIconSVG />
      </div>
