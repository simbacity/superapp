...
const server = z.object({
  PLANETSCALE_PRISMA_DATABASE_URL: z.string().url(),
  ...
  WEB_PUSH_VAPID_PUBLIC_KEY: z.string(),
});
 ...
 */
const processEnv = {
  PLANETSCALE_PRISMA_DATABASE_URL: process.env.PLANETSCALE_PRISMA_DATABASE_URL,
